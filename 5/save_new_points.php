...
<?php
 ...
 $sql_add =  $sql_add = "INSERT INTO points SET id_shop='" . $_GET['id_shop']
."', id_city='".$_GET['id_city']."', volume='".$_GET['volume']."', balance='".$_GET['balance']
."', fio='".$_GET['fio']."', address='".$_GET['address']."'";
